...
<body class="bodyback">
	...
	<main class="container">
		<h2 class="d-flex align-items-end justify-content-center mt-3">후보조회</h2>
		<div class="members row justify-content-around">
			<c:forEach var="candidate" items="${candidateList}">
				<div class="row member-info col-6 justify-content-center">
					<h3 class="text-center">${candidate.m_name}</h3>
					<a class="text-center" href="party_view.doVote?p_code=${candidate.p_code}"><img src="img/profile.png" alt="" class="w-50 mb-3 "></a>
					<h4 class="text-center">기호: ${candidate.m_no}번</h4>
					<h4 class="text-center">${candidate.p_name}</h4>
					<h4 class="text-center">학력: ${candidate.p_school}</h4>
					<h4 class="text-center">지역: ${candidate.m_city}</h4>
					<h4 class="text-center">${candidate.p_tel1}-${candidate.p_tel2}-${candidate.p_tel3}</h4>
					<div>
						<br>
					</div>
				</div>
