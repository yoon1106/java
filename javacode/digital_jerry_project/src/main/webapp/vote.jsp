...
<body class="bodyback">
	...
	<main class="container">
		...
		<h2 class="d-flex align-items-end justify-content-center mt-3">투표하기</h2>
		<table width="500" cellpadding="0" cellspacing="0" border="1" style="margin-left:auto; margin-right:auto;">
			<form action="vote.doVote" method="post">
				<tr>
					<td>주민번호</td>
					<td><input type="text" name="v_jumin" size="50"></td>
				</tr>
				<tr>
					<td>성명</td>
				...
				<tr>
					<td>투표번호</td>
					<td><input type="text" name="m_no" size="50"></td>
				</tr>
				<tr>
					<td>투표시간</td>
					<td><input type="text" name="v_time" size="50"></td>
				</tr>
				<tr>
					<td>투표장소</td>
					<td><input type="text" name="v_area" size="50"></td>
				</tr>
				<tr>
					<td>유권자확인</td>
					<td >
						확인<input type="radio" name="v_confirm" value="1" >&nbsp;&nbsp;
						
						미확인<input type="radio" name="v_confirm" value="0">
					</td>
				</tr>
				<tr >
					<td colspan="2">
